          ...
          <div className="w-full max-w-5xl mx-auto overflow-hidden">
            <div className="flex animate-scroll gap-8">
              {companies.map((company, index) => (
                <div key={index} className="flex-shrink-0 flex items-center justify-center h-14 px-6 rounded-lg bg-white/60 text-blue-800 font-medium text-sm hover:text-blue-900 hover:bg-white/80 transition-all duration-300 hover:scale-105 backdrop-blur-sm dark:bg-white/10 dark:text-blue-200 dark:hover:text-blue-100 dark:hover:bg-white/20 min-w-[200px]">
                  {company.name}
                </div>
              ))}
            </div>
